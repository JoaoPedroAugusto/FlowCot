    ...
    <AppProvider>
      <div className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
          <div className="flex-1 relative h-[60vh] sm:h-[70vh] md:h-[75vh] lg:h-full">
            <MapContainer onSelectRegion={setSelectedRegion} />
          </div>

          <div className="w-full lg:w-96 border-t lg:border-t-0 lg:border-l border-gray-200 bg-white overflow-y-auto lg:h-full scroll-smooth">
            {selectedRegion ? (
