              ...
              {[1,2,3,4,5].map((step, i) => (
                <div key={i} className="bg-white p-5 rounded-lg shadow-sm">
                  <div className="flex items-center mb-3">
                    <div className="bg-primary-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-bold mr-3">{step}</div>
                    <h4 className="text-lg font-semibold text-primary-800">
                      {[
                        "Definição dos Níveis de Referência",
                        "Quantificação da Produtividade Real",
